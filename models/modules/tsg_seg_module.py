...
class get_model(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(512, 256)      # 只有一个2个维度，所以用linear，三个维度用conv1d
        self.bn1 = nn.LayerNorm(256) # LayerNorm， 每一个B做一次norm,  BatchNorm, 所有B一起做norm。nn.BatchNorm1d(256)
    ...
    def forward(self, xyz):
        ...
        _, id_pred = self.flatten_sa(l3_xyz_1, l3_points_1)     # 相当于点云分类了，将512 + 3 ->256 -> 512  (B, 512, 1)
