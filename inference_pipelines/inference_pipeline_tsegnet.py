...
class InferencePipeLine:
    ...
    def __call__(self, stl_path):
        ...
        print("dbscan_results_count: ", np.unique(dbscan_results.labels_), np.unique(dbscan_results.labels_).shape)
        center_points = []
        ...
        pred_labels[pred_labels>=9] += 2            # [9......16] - > [11,......18]
        pred_labels[pred_labels>0] += 10            # [1......8] - > [11,......18]
